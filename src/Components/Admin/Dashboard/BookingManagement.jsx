...
const BookingManagement = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      const response = await axios.get('https://room-booking-backend-std3.onrender.com/api/bookings/admin/all', config);
  ...
  const handleStatusChange = async (bookingId, newStatus) => {
    try {
      ...
      await axios.patch(`https://room-booking-backend-std3.onrender.com/api/admin/bookings/${bookingId}/status`, {
        status: newStatus
      }, config);
