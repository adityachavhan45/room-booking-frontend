...
const RoomManagement = () => {
  ...
  const fetchRooms = async () => {
    try {
      ...
      const response = await axios.get('https://room-booking-backend-production.up.railway.app/api/admin/rooms', config);
  ...
  const handleAddRoom = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://room-booking-backend-production.up.railway.app/api/admin/rooms', roomData, {
        headers: { 
  ...
  const handleEditRoom = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://room-booking-backend-production.up.railway.app/admin/rooms/${editingRoom._id}`,
        roomData,
        {
          headers: { 
            'Authorization': `Bearer ${adminToken}`,
  ...
  const handleDeleteRoom = async (roomId) => {
    if (window.confirm('Are you sure you want to delete this room?')) {
      ...
      try {
        ...
        const response = await axios.delete(`https://room-booking-backend-production.up.railway.app/api/admin/rooms/${roomId}`, config);
        if (response.data.success) {
          await fetchRooms();
        }
      } catch (error) {
